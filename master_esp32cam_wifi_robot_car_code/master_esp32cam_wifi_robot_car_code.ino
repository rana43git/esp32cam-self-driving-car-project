...
extern String GPSdataMain = "Not Set Yet";

/* Wifi Crdentials */
String sta_ssid = "";      // set Wifi network you want to connect to
String sta_password = "";  // set password for Wifi network

String hostname = "ESP32CAM WiFi Robot Car";
String hostpassword = "robotcar2025";
...
void setup() {
  ...
  Serial.println("Host Password: " + hostpassword);
  ...
  Serial.print(myIP);
  Serial.println(":81/stream' to get live video feed.");
